  ...
  <div class="card" style="padding:16px;">
    <div class="detail-grid">
      ...
      <div class="detail-card">
        ...
        <div class="v"><span id="dReorder">—</span><span class="muted" style="font-weight:900;">—</span></div>
...
async function init(){
  ...
  function renderList(){
    ...
    items.forEach(it=>{
      ...
      const exp = computeExpiryInfo(m.nearestExpiry || '—');
  ...
  function renderDetail(sku){
    ...
    document.getElementById('dReorder').textContent = (rp ? rp.toLocaleString('en-US') : '—') + ' ' + uomMeta.baseUom;
