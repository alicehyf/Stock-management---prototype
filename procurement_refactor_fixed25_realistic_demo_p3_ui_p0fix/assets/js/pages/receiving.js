...
<div id="rcvListView">
    ...
    <!-- Quick receive modal -->
    <div class="modal" id="quickReceiveModal" style="display:none;">
...
`;
  ...
  function init(){
    ...
    function renderDetail(rcv){
      ...
      document.getElementById('rcvStatusTag').innerHTML = statusTag(rcv.status);
    ...
    function closeQuickReceive(){ modal.style.display = 'none'; }
    ...
    document.getElementById('btnCompleteReceiving')?.addEventListener('click', completeReceiving);
