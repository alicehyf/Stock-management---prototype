...
<div class="breadcrumb">
    ...
    <section id="viewCount" class="card" style="padding:14px;margin-top:14px; display:none;">
      ...
      <table class="count-table" aria-label="Count table">
        ...
        <tbody id="countBody">
          <tr data-name="Anise Star" data-category="Spices" data-expected-qty="790" data-expected-exp="2026-06-30">
            <td class="name" style="font-weight:950;color:#0b2bd6;">Anise Star
              <div class="mini-muted">Expected (tap to view): <span class="mono">790 g</span> · <span class="mono">2026-06-30</span></div>
            </td>
          ...
          <tr data-name="Avocado" data-category="Produce" data-expected-qty="3200" data-expected-exp="2026-01-31">
            <td style="font-weight:950;">Avocado
              <div class="mini-muted">Expected (tap to view): <span class="mono">3,200 g</span> · <span class="mono">2026-01-31</span></div>
            </td>
      ...
      <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:12px;flex-wrap:wrap;">
        <div>
          ...
          <div class="mini-muted">
            Compare expected vs counted. Flagged items should be recounted before posting adjustments.
          </div>
        </div>
        <div class="right-actions">
      ...
      function renderReview(){
        ...
        items.forEach(d => {
          ...
          tr.innerHTML = `
            ...
            <td>${(()=>{ const vc = d.diff>0 ? "ok" : d.diff<0 ? "bad" : "neutral"; const extra = d.expiryFlag ? ' <span class="cell-muted">· shelf earlier</span>' : ''; return `<span class="tag ${vc}" title="Variance vs expected"><span class="dot"></span>${d.varianceText}</span>${extra}`; })()}</td>
